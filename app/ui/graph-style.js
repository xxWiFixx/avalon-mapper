...
return [
  ...
  // Пока узел тащат мышью, подписи рёбер гаснут. Холст перерисовывается на каждое
  // движение, а дороже всего в кадре текст: сотня подписей с подложками. Без них
  // перетаскивание не разгоняет процессор, а глазу в этот момент нужны точки и линии.
  // Класс вешает map.js на grab и снимает на free.
  { selector: 'edge.drag-lite', style: { label: '' } },
