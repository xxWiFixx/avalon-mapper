...
//
// ПОВТОРЫ. Один и тот же ответ приходит дважды и без всякой игры: слушателей столько,
// сколько сетевых интерфейсов, и пакет ловят сразу несколько. Плюс переотправка при
// потере. Поэтому наружу уходит только СМЕНА зоны.
//
// ЧЕГО ЭТА ПРОВЕРКА НЕ ДЕЛАЕТ. Она сравнивает лишь с ПРЕДЫДУЩЕЙ зоной, поэтому от
// ложных срабатываний не спасает: кольцо «A → B → C → A» проходит её насквозь. Раньше
// на неё возлагали именно эту работу, и игрок увидел повторяющиеся круги зон. Отсев
